...
urlpatterns = [
    ...
    path("get-maternita-by-employee", views.get_maternita_by_employee, name="get-maternita-by-employee"),
    path("get-maternita-detail/<int:pk>", views.get_maternita_detail, name="get-maternita-detail"),
    path("maternita-save", views.maternita_save, name="maternita-save"),
    path("maternita-documents/<int:mat_id>", views.maternita_documents, name="maternita-documents"),
    path("maternita-edit/<int:pk>", views.maternita_edit, name="maternita-edit"),
    ...
    path("document-update/<int:id>", views.document_update, name="document-update"),
    path(
