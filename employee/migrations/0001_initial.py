...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Duty Role',
                'verbose_name_plural': 'Duty Roles',
            },
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ...
                ('domicilio_address', models.TextField(blank=True, max_length=200, null=True)),
                ('domicilio_country', models.CharField(blank=True, max_length=100, null=True)),
                ('domicilio_state', models.CharField(blank=True, max_length=100, null=True)),
                ('domicilio_zip', models.CharField(blank=True, max_length=20, null=True)),
                ('domicilio_citta', models.CharField(blank=True, max_length=255, null=True, verbose_name='Domicilio Città')),
                ('docimicilio_provincia', models.CharField(blank=True, max_length=100, null=True, verbose_name='Domicilio Provincia')),
                ('residenza_country', models.CharField(blank=True, max_length=100, null=True, verbose_name='Residenza Country')),
                ('residenza_state', models.CharField(blank=True, max_length=100, null=True, verbose_name='Residenza State')),
                ('residenza_address', models.TextField(blank=True, max_length=200, null=True, verbose_name='Residenza Address')),
                ('residenza_zip', models.CharField(blank=True, max_length=20, null=True, verbose_name='Residenza ZIP')),
                ('residenza_citta', models.CharField(blank=True, max_length=255, null=True, verbose_name='Residenza Città')),
                ('residenza_provincia', models.CharField(blank=True, max_length=100, null=True, verbose_name='Residenza Provincia')),
                ('dob', models.DateField(blank=True, null=True)),
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], default='male', max_length=10, null=True)),
                ('nascita_citta', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nascita Città')),
                ('nascita_provincia', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nascita Provincia')),
                ('codice_fiscale', models.CharField(blank=True, max_length=16, null=True, validators=[employee.models.validate_codice_fiscale], verbose_name='Codice Fiscale')),
                ('categoria_protetta', models.BooleanField(default=False, verbose_name='Categoria Protetta')),
                ('codice_paghe', models.CharField(blank=True, max_length=64, null=True, verbose_name='Codice Paghe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('work_area_type', models.CharField(blank=True, choices=[('SEDE', 'SEDE'), ('NEGOZI', 'NEGOZI')], max_length=10, null=True, verbose_name='Work Area Type')),
                ('department_code', models.CharField(blank=True, max_length=30, null=True, verbose_name='Department Code')),
                ('store_code', models.CharField(blank=True, max_length=30, null=True, verbose_name='Store Code')),
                ('store_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Store')),
                ...
                ('salary_hour', models.DecimalField(blank=True, decimal_places=4, default=0, max_digits=15, null=True, verbose_name='Salary Per Hour')),
                ('export_payslip', models.BooleanField(default=False, verbose_name='Esporta Cedolino')),
                ('mirror_payslip', models.BooleanField(default=False, verbose_name='Cedolino Speculare')),
                ('premi', models.BooleanField(default=False, verbose_name='Premi')),
                ('additional_info', models.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Employee Duty History',
                'verbose_name_plural': 'Employee Duty Histories',
